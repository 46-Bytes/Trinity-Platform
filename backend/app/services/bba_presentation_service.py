...
class BBAPresentationService:
    ...
    def _build_user_content(self, bba: BBA) -> str:
        ...
        sections = [
            ...
            "",
            "## Expanded Findings",
            json.dumps(expanded_list, separators=(',', ':')) if expanded_list else "Not available.",
            "",
            "## Snapshot Table",
            json.dumps(snapshot_rows, separators=(',', ':')) if snapshot_rows else "Not available.",
            "",
            "## 12-Month Plan Recommendations",
            json.dumps(recommendations, separators=(',', ':')) if recommendations else "Not available.",
            "",
            "## Timeline Summary",
            json.dumps(timeline_rows, separators=(',', ':')) if timeline_rows else "Not available.",
            "",
            "## Instructions",
