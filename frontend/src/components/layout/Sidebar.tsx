...
const navItems: NavItem[] = [
  ...
  { label: 'Engagements', href: '/dashboard/engagements', icon: FolderOpen, roles: ['super_admin', 'advisor', 'client', 'firm_admin', 'firm_advisor','admin'] },
  { label: 'Tasks', href: '/dashboard/tasks', icon: CheckSquare, roles: ['super_admin', 'admin', 'advisor', 'client', 'firm_admin', '1r'] },
