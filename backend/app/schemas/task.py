...
class TaskBase(BaseModel):
    ...
    module_reference: Optional[str] = Field(None, max_length=50, description="Module reference or category name (e.g., M1, M2, or program stage_code like 'M_FIN')")
    section: Optional[str] = Field(None, max_length=20, description="Program section grouping: must_do | optional | ai_custom")
