...
export const PLAN_SECTIONS: readonly PlanSectionConfig[] = [
  ...
  { key: 'operations_strategy',        title: 'Operational Strategy',                                 required: false, hasDiagnosticImplications: false, surfaceThemesAfter: false },
  { key: 'hr_strategy',                title: 'HR Strategy',                                          required: false, hasDiagnosticImplications: false, surfaceThemesAfter: false },
