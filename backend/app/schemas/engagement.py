...
# Schema for a generated document item (engagement-wide generated documents view)
class GeneratedDocumentItem(BaseModel):
    """A single downloadable deliverable generated by one of the engagement's tools."""
    id: str = Field(..., description="Stable client-side id, e.g. 'bba-report-{uuid}'")
    tool: str = Field(..., description="Display label for the source tool")
    name: str = Field(..., description="Display file name")
    file_type: str = Field(..., description="docx | xlsx | pptx")
